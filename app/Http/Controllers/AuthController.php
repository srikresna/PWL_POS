...
class AuthController extends Controller
{
    ...
    public function proses_login(Request $request)
    {
        ...
        // validasi nya username & pasword wajib di isi
        $request->validate([
            'username' => 'required',
            'password' => 'required'
        ]);
        ...
        if (Auth::attempt($credential)) {
            ...
            // Kalau berhasil simpan datauser nya di variable $user
            $user = Auth::user();
        ...
        // Jika ga ada data user yang valid maka kembalikan agi ke halaman login
    ...
    public function proses_register(Request $request)
    {
        ...
        // validasi username itu harus unique atau tidak boleh duplicated
